...
Independent repositories can configure the hosted fallbacks and serial runners through the [hosted CI configuration](2026-09-12-fork-hosted-ci.md). Empty overrides preserve the pools described here.
