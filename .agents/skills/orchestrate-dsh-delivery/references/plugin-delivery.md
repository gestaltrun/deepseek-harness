...
Initial product acceptance precedes independent scheme/code review in ODD. Revalidate affected behavior after fixes. For multi-repository Gestaltrun work, [coordinated release](../../dsh-upstream-integration/references/coordinated-release.md) owns candidate CI, package staging, final promotion, and partial failure. These instructions do not install registry protections or CI in another repository.
