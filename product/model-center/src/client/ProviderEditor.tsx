      ...
      <>
        ...
        {props.credentialOnly === true ? null : <details className={styles['customized']}>
          ...
          <div className={styles['customizedBody']}>
            ...
            {family !== 'deepseek' && <div className={styles['field']}>
              <span className={styles['fieldLabel']}>{t('defaultInput')}</span>
              <InputModalityTags value={draft['defaultInput']} disabled={disabled} name={t('defaultInput')}
                labels={{ text: t('modalityText'), image: t('modalityImage') }} onChange={value => {
                  setDraft(current => value === undefined ? schema.deletePath(current, ['defaultInput']) : schema.setPath(current, ['defaultInput'], value))
                }} />
