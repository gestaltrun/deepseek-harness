  ...
  return (
    <div className={styles['editor']}>
      ...
      <div className={styles['field']}>
        ...
        <InputModalityTags value={defaultInput} disabled={profileDisabled} name={t('defaultInput')}
          labels={{ text: t('modalityText'), image: t('modalityImage') }} onChange={setDefaultInput} />
