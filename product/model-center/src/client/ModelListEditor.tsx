...
import { ModelCapabilitiesFields } from './ModelCapabilitiesFields.tsx'
          ...
          {expanded.has(index)
            ? (
              <div className={styles['modelAdvanced']}>
                ...
                <ModelCapabilitiesFields model={model} disabled={disabled} t={t} onChange={change => { patch(index, change) }} />
              </div>
            )
            : null}
        </div>
