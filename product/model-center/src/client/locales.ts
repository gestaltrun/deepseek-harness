...
export const en = {
  defaultInput: "Default input types",
  defaultInputHint: "Models can override the provider input types.",
  modelInput: "Input types",
  modalityText: "Text",
  modalityImage: "Image",
  modelReasoning: "Supported reasoning efforts",
  effortOff: "Off",
  ...
  defaultReasoningInherit: "Inherit provider default",
  defaultReasoningUnavailable: "Unavailable selection",
  defaultReasoningHint: "An explicit session selection takes precedence.",
  reasoningWireValues: "Request values",
  reasoningWireOmitted: "Omit parameter",
  modelReasoningInvalid: "Declare a reasoning effort beyond off and provide non-empty request values.",
  modelDefaultInvalid: "The default must be one of the model’s supported reasoning efforts.",
  nav: 'Models',
  title: 'Models',
...
export const zh: { [Key in keyof typeof en]: string } = {
  defaultInput: "默认输入类型",
  defaultInputHint: "模型可单独覆盖提供方的输入类型。",
  modelInput: "输入类型",
  modalityText: "文字",
  modalityImage: "图片",
  modelReasoning: "支持的思考档位",
  effortOff: "关闭",
  effortMinimal: "极低",
  effortLow: "低",
  effortMedium: "中",
  ...
  effortXhigh: "很高",
  effortMax: "最高",
  defaultReasoning: "默认思考档位",
  defaultReasoningInherit: "继承提供方默认",
  defaultReasoningUnavailable: "所选档位不可用",
  defaultReasoningHint: "会话中的显式选择优先于此默认值。",
  reasoningWireValues: "请求中的档位值",
  reasoningWireOmitted: "不发送参数",
  modelReasoningInvalid: "请声明关闭以外的思考档位，并填写对应请求值。",
  modelDefaultInvalid: "默认档位必须属于模型支持的思考档位。",
  nav: '模型',
  title: '模型',
