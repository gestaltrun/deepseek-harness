...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Product settings cards for the Workspace selected from its own row. */
    'sidebar.workspaces.imSettings': { kind: 'list'; scope: 'root'; owner: { workspaceId: WorkspaceId } }
    /** Directory-flow hole under the product browsing region. */
    'sidebar.workspaces.imDirectoryFlow': { kind: 'single'; scope: 'root'; owner: DirectoryFlowOwnerProps }
  }
}
...
export type DirectoryFlowSlotName =
  ...
  | 'sidebar.workspaces.imDirectoryFlow'
...
export type WorkspaceBrowserProps =
  ...
  & PropsRenderSlots<'sidebar.workspaces.imDirectoryFlow' | 'sidebar.workspaces.imSettings'>
  & PropsStore<ReturnType<typeof createWorkspaceViewStore>>
  & Omit<WorkspaceBrowserInjected, 'hooks'>
  & PropsHooks<WorkspaceBrowserInjected['hooks']>
  & PropsLocale<'gestaltrun.imWorkspace'>
