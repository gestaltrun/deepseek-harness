            ...
            >
              <ProjectRowItem
                ...
                actions={group.workspaceId === undefined
                  ...
                  : {
                    settings: () => {
                      if (group.workspaceId !== undefined) onSettingsRequest(group.workspaceId)
                    },
                    rename: () => {
    ...
    <div className={clsx(css.root, !wide && css.rail)}>
      <div className={css.sectionHeader}>
        ...
        <WorkspacePickFlow
          ...
          renderDirectoryFlow={owner => renderSlot('sidebar.workspaces.imDirectoryFlow', owner)}
          addOnly
          side="right"
          onPick={(workspaceId) => {
            setWsPickerOpen(false)
          ...
          : groupBy === 'flat'
            ...
            : (
              <SessionTree
                ...
                home={home}
                t={t}
                onSettingsRequest={setSettingsWorkspaceId}
